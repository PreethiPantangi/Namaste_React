...
export const withOfferText = (RestaurantCard) => {
    return ({resData}) => {
        ...
        return (
            <div className='relative'>
                <label className='absolute font-extrabold  top-40 left-5 text-white z-10 hover:cursor-pointer hover:scale-85'>{offerDetails.header + " " + offerDetails.subHeader}</label>
