  ...
  return (
    <div>
      <div className='flex justify-between mt-5'>
        ...
        <div class="m-0 antialiased font-family1 font-bold text-2xl leading-28 tracking-tight text-rgba-2-6-12-0-92 overflow-hidden w-full flex flex-col">{title}</div>
