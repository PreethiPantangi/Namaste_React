...
const RestaurantCard = (props) => {
    ...
    return (
        <div className={shouldEnableCarousel ? "h-92 w-52 hover:cursor-pointer hover:scale-95" : "w-56 h-92 p-2 m-2 hover:cursor-pointer hover:scale-95 overflow-hidden"}>
            <img 
